...
const TaskManagement = () => {
  ...
  const [form, setForm] = useState({ employee_id: '', title: '', description: '', status: '', due_date: '' });
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setForm({ employee_id: '', title: '', description: '', status: '', due_date: '' });
      setEditId(null);
  ...
  return (
    <div className="min-h-screen bg-primary-100 p-6">
      <div className="container mx-auto">
        <h1 className="text-3xl font-bold text-primary-500 mb-6">Manage Tasks</h1>
        {error && (
        ...
        <div className="bg-white rounded-lg shadow-lg overflow-x-auto">
          <table className="w-full border-collapse">
            ...
            <tbody>
              {tasks.map((task) => (
                <tr key={task.id} className="hover:bg-primary-100 transition-colors duration-200">
                  <td className="p-3 border-b">{task.employee_name}</td>
                  ...
                  <td className="p-3 border-b">{new Date(task.due_date).toLocaleDateString()}</td>
            ...
            <div className="bg-white p-6 rounded-lg shadow-lg w-full max-w-lg">
              ...
              <form onSubmit={handleSubmit}>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                  ...
                  <div>
                    <label htmlFor="due_date" className="block text-gray-700 mb-2 font-medium">
                      Due Date
                    </label>
                    <input
                      type="date"
